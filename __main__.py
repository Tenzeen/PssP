...
class Medications_patient(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    mrn = db.Column(db.String(255), db.ForeignKey('patients.mrn'))
    ndc_code = db.Column(db.String(255), db.ForeignKey('medications.ndc_code'))
...
class Medications(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    ndc_code = db.Column(db.String(255))
    ndc_description = db.Column(db.String(255))

    # this first function __init__ is to establish the class for python GUI
    def __init__(self, ndc_code, ndc_description):
        self.ndc_code = ndc_code
        self.ndc_description = ndc_description
    ...
    def to_json(self):
        return {
            'id': self.id,
            'ndc_code': self.ndc_code,
            'ndc_description': self.ndc_description
        }
